...
<script>
  ...
  export default {
    name: 'PantherOrderModalForJEditableTable',
    components: {
    ...
    data() {
      return {
        ...
        url: {
          add: '/test/pantherOrderMain/add',
          edit: '/test/pantherOrderMain/edit',
          orderCustomerList: '/test/pantherOrderMain/queryOrderCustomerListByMainId',
          orderTicketList: '/test/pantherOrderMain/queryOrderTicketListByMainId'
        }
      }
    },
    created() {
