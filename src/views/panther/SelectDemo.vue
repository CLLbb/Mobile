...
<script>
  ...
  import JSelectDepart from '@/components/pantherbiz/JSelectDepart'
  import JSelectUserByDep from '@/components/pantherbiz/JSelectUserByDep'
  import JSelectMultiUser from '@/components/pantherbiz/JSelectMultiUser'
  import JSelectRole from '@/components/pantherbiz/JSelectRole'
  import JCheckbox from '@/components/panther/JCheckbox'
  import JCodeEditor from '@/components/panther/JCodeEditor'
  import JDate from '@/components/panther/JDate'
  import JEditor from '@/components/panther/JEditor'
  import JEllipsis from '@/components/panther/JEllipsis'
  import JSlider from '@/components/panther/JSlider'
  import JSelectMultiple from '@/components/panther/JSelectMultiple'
  import JTreeDict from "../../components/panther/JTreeDict.vue";
  import JCron from "@/components/panther/JCron.vue";
  import JTreeSelect from '@/components/panther/JTreeSelect'
  import JSuperQuery from '@/components/panther/JSuperQuery'
  import JUpload from '@/components/panther/JUpload'
  import JImageUpload from '@/components/panther/JImageUpload'
  import JSelectPosition from '@comp/pantherbiz/JSelectPosition'
  import JCategorySelect from '@comp/panther/JCategorySelect'
  import JMultiSelectTag from '@comp/dict/JMultiSelectTag'
  import JInput from '@comp/panther/JInput'
  import JAreaLinkage from '@comp/panther/JAreaLinkage'
  import JMarkdownEditor from '@/components/panther/JMarkdownEditor/index'
