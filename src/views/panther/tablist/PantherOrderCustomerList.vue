<template>
  <a-card :bordered="false">
    ...
    <!-- table区域-end -->
    <!-- 表单区域 -->
    <pantherOrderCustomer-modal ref="modalForm" @ok="modalFormOk"></pantherOrderCustomer-modal>
  </a-card>
</template>

<script>
  import PantherOrderCustomerModal from './form/PantherOrderCustomerModal'
  import PantherOrderDMainList from './PantherOrderDMainList'
  import {PantherListMixin} from '@/mixins/PantherListMixin'
  import {getAction} from '@/api/manage'

  export default {
    name: "PantherOrderCustomerList",
    mixins: [PantherListMixin],
    components: {
      PantherOrderDMainList,
