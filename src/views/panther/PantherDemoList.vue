<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <pantherDemo-modal ref="modalForm" @ok="modalFormOk"></pantherDemo-modal>

    <!-- 一对多表单区域 -->
    <PantherDemoTabsModal ref="pantherDemoTabsModal" @ok="modalFormOk"></PantherDemoTabsModal>

  </a-card>
</template>

<script>
  import PantherDemoModal from './modules/PantherDemoModal'
  import JSuperQuery from '@/components/panther/JSuperQuery.vue';
  import JInput from '@/components/panther/JInput.vue';
  import PantherDemoTabsModal from './modules/PantherDemoTabsModal'
  ...
  export default {
    ...
    methods: {
      ...
      onetomany: function () {
        this.$refs.pantherDemoTabsModal.add();
        this.$refs.pantherDemoTabsModal.title = "编辑";
      },
      //跳转单据页面
      jump() {
        this.$router.push({path: '/panther/helloworld'})
      },
