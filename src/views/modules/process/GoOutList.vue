<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" @click="searchReset('出差')" icon="reload" style="margin-left: 8px">重置</a-button>
    ...
    <div class="table-operator" style="border-top: 5px">
      <a-button @click="handleAdd" type="primary" icon="plus">出差申请</a-button>
    </div>
    ...
    <go-out-modal ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import GoOutModal from './modules/GoOutModal'
  ...
  export default {
    ...
    data() {
      return {
        description: '这是出差申请页面',
        queryParam: {recordTag:'出差'},
          columns: [
          {
            title: '出差时段',
            align: "center",
