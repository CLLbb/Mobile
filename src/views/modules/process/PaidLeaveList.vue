<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" @click="searchReset('调休')" icon="reload" style="margin-left: 8px">重置</a-button>
    ...
    <div class="table-operator" style="border-top: 5px">
      <a-button @click="handleAdd" type="primary" icon="plus">调休申请</a-button>
    </div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" >
            <a v-show="record.approve == 1">撤回</a>
          </a-popconfirm>
    ...
    <paid-leave-modal ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import PaidLeaveModal from './modules/PaidLeaveModal'
  ...
  export default {
    ...
    data() {
      return {
        description: '这是调休申请页面',
        queryParam: {recordTag:'调休'},
          columns: [
          {
            title: '调休时段',
            align: "center",
