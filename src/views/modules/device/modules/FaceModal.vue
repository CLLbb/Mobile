  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="用户工号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="用户工号" v-decorator="['workNo', validatorRules.workNo]"/>
        </a-form-item>
        ...
        <a-form-item label="电话号码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="电话号码" v-decorator="['phone', validatorRules.phone]"/>
        </a-form-item>
...
<script>
  ...
  import {addFaceMessage,editFaceMessage,queryUserRole,queryDeviceAll} from '@/api/api'
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'workNo','userName','deviceName','sn','url','age','sex','nation','phone','hometown','address'))
        });
      },
      close () {
        this.$emit('close');
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if(!this.model.id){
              ...
              obj=addFaceMessage(formData);
            }else{
              obj=editFaceMessage(formData);
            }
            obj.then((res)=>{
              if(res.success){
