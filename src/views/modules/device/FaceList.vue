<template>
  <a-card :bordered="false">
    ...
    <face-modal ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import FaceModal from './modules/FaceModal'
    ...
    data() {
      return {
        ...
        url: {
          ...
          list: "/face/message/list",
          delete: "/face/message/delete",
          deleteBatch: "/face/message/deleteBatch",
          queryById: "/face/message/queryById",
          issueBatch:"/face/message/issueBatch"
        },
      }
    },
    computed: {
