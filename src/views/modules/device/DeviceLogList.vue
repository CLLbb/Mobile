...
<!--        <a-tab-pane tab="登录日志" key="1"></a-tab-pane>-->
        <a-tab-pane tab="设备日志" key="2"></a-tab-pane>
      </a-tabs>
    </div>
    ...
    <a-table
      ...
      <span slot="action" slot-scope="text, record">
          <a @click="recycleBinVisible=true,msgId=record.msgId" >设备接收情况</a>
        </span>
    </a-table>
    <advert-device-modal :visible.sync="recycleBinVisible" :msgId="msgId" @ok="modalFormOk"/>
    <!-- table区域-end -->
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        {
          title: '操作类型',
          dataIndex: 'operateType',//operateType_dictText
