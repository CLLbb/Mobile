    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="标题" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入标题号" v-decorator="['title', validatorRules.title]"/>
        </a-form-item>
...
<script>
  ...
  import {addNews,editNews,queryUserRole,queryall} from '@/api/api'
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'title','remark'))
        });
      },
      close () {
        this.$emit('close');
