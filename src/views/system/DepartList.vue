          ...
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              ...
              <a-form-item
                ...
                :wrapperCol="wrapperCol"
                label="关联设备">
                <a-input placeholder="请输入设备SN号" v-decorator="['sn', {'initialValue':''} ]"/>
              </a-form-item>
              <a-form-item
                :labelCol="labelCol"
                :wrapperCol="wrapperCol"
    ...
    methods: {
      ...
      setValuesToForm(record) {
        ...
        this.$nextTick(() => {
          ...
          this.form.setFieldsValue(pick(record, 'departName','orgCategory', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'memo','sn'))
        })
      },
