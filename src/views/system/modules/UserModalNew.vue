    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <template v-if="!model.id">
          ...
          <a-form-item label="确认密码22" :labelCol="labelCol" :wrapperCol="wrapperCol" >
        ...
        <!--租户分配-->
        <a-form-item label="租户分配11" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled">
