  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="角色分配111" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!roleDisabled" >
          <a-select
            mode="multiple"
            style="width: 100%"
            placeholder="请选择用户角色"
        ...
        <!--部门分配-->
        <a-form-item label="部门分配111" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled">
          <a-input-search
            placeholder="点击选择部门"
       ...
       <!-- update--begin--autor:wangshuai-----date:20200108------for：新增身份和负责部门------ -->
        ...
        <a-form-item label="头像11" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <!-- <j-image-upload class="avatar-uploader" text="上传" v-model="fileList" ></j-image-upload> -->
        </a-form-item>

        <a-form-item label="生日111" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-date-picker
            style="width: 100%"
            placeholder="请选择生日"
