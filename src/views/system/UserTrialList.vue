<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleChangeTrial(record.id,record.probationPeriod)" >调整试用期</a>

          <a-divider type="vertical" />

          <a @click="positiveOrLeave(record.id,1)" >转正</a>
    ...
    <user-trial-modal ref="passwordmodal" @ok="passwordModalOk"/>
...
<script>
  ...
  import UserTrialModal from './modules/UserTrialModal'
