<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator" style="border-top: 5px">
      <a-button @click="handleAdd" type="primary" icon="plus">新增密钥</a-button>
    </div>
    ...
    <key-rule-modal ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import KeyRuleModal from './modules/KeyRuleModal'
    ...
    data() {
      return {
        ...
        url: {
          ...
          list: "/key/rule/list",
          delete: "/key/rule/delete",
          deleteBatch: "/key/rule/deleteBatch",
          queryById: "/key/rule/queryById"
        },
      }
    },
    computed: {
