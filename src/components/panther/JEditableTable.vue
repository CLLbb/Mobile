...
<script>
  ...
  import JInputPop from '@/components/panther/minipop/JInputPop'
  import JFilePop from '@/components/panther/minipop/JFilePop'
  ...
  export default {
    ...
    methods: {
      ...
      getUploadAction(value) {
        if (!value) {
          return window._CONFIG['domianURL'] + '/operate/user/uploadUserImg'
        } else {
          return value
        }
      },
